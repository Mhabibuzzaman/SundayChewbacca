...
public class PracticeException_TryCatch {
	...
	/* Java Exceptions - Use "try - catch - finally"
	 A. Built-in Exceptions - Built - in - exception throws by java which explain certain error situations
	 	...
	 	9. NullPointerException - referring to the members of a null project
	   ...
	   12. StringIndexOutOfBoundsException - String class methods to indicate that an index is either negative or greater than the size of String.
